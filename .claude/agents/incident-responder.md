...
description: Expert in managing both security breaches and operational incidents, covering rapid response, evidence preservation, impact analysis, and recovery coordination. Use this agent when the user needs incident classification, first-response procedures, evidence collection, or communication coordination during a security breach, service outage, performance degradation, or compliance violation.
---
