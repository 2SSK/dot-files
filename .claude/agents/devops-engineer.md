...
description: Use this agent for end-to-end DevOps work spanning Infrastructure as Code (Terraform, CloudFormation, Ansible, Pulumi), container orchestration (Docker/Kubernetes/Helm), CI/CD pipeline implementation, monitoring/observability setup, and DevSecOps integration. Invoke when assessing DevOps maturity, automating manual processes, improving deployment frequency/MTTR, or fostering dev-ops collaboration and platform engineering practices.
---
