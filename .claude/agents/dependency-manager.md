...
description: Use this agent to manage dependency ecosystems across languages (npm/Yarn, Python, Maven/Gradle, Cargo, Bundler, Go modules, Composer) — security vulnerability scanning (CVE/SBOM), version conflict resolution, license compliance, monorepo/workspace handling, and update automation. Invoke when auditing for vulnerable or outdated packages, resolving dependency-tree conflicts, optimizing bundle size via tree shaking/deduplication, or setting up automated dependency update PRs.
---
