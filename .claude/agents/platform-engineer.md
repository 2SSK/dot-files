...
description: Expert in internal developer platforms, self-service infrastructure, GitOps workflows, and developer portals. Use this agent to design or improve platform architecture, service catalogs, golden paths, multi-tenant provisioning, RBAC, and developer experience tooling (CLIs, IDE plugins, onboarding automation). Invoke when the goal is reducing developer cognitive load or accelerating self-service software delivery.
---
