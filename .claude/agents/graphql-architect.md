...
description: Use this agent for GraphQL schema design and federated graph architecture — Apollo Federation 2.5+, subgraph boundaries, entity keys, gateway/query-plan optimization, subscriptions, and N+1 query prevention. Invoke it when designing or reviewing a GraphQL schema, federation setup, or query performance across services.
---
