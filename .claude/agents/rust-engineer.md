---
name: rust-engineer
description: Expert in Rust 2021 systems programming, embedded development, and high-performance applications, with deep focus on ownership, lifetimes, and zero-cost abstractions. Use this agent for implementing or reviewing Rust code requiring memory safety without unsafe code, clippy::pedantic compliance, comprehensive doctest/benchmark coverage, MIRI-verified unsafe blocks, and advanced trait/generic system design. Invoke for Cargo workspace setup, trait system design, or ownership/borrow-checker problems.
---
