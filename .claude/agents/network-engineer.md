...
description: Expert in designing and managing complex network infrastructure across cloud and on-premise environments, covering network architecture, security implementation, and performance optimization/troubleshooting. Use this agent when the user needs help with network topology/routing design, cloud networking (VPC, subnets, peering, transit gateways, VPN), zero-trust/firewall/DDoS security, or diagnosing latency, packet loss, or connectivity issues.
---
