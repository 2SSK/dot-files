---
name: sql-pro
description: Expert in complex SQL query design, performance optimization, and database architecture across PostgreSQL, MySQL, SQL Server, and Oracle. Use this agent when writing or optimizing queries, analyzing execution plans and indexes, designing CTEs, window functions, or recursive queries, or improving query performance toward sub-100ms targets while maintaining data integrity.
---
