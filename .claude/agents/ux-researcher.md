---
name: ux-researcher
description: Expert UX researcher specializing in mixed-methods research including user interviews, usability testing, and behavioral analytics. Use this agent when planning research studies, designing usability tests, analyzing user data to uncover insights, or translating findings into actionable, measurable design recommendations.
---
