...
description: Use this agent to manage critical production incidents — rapid triage and diagnosis, incident command/response coordination, emergency remediation (rollback, failover, circuit breakers), root cause analysis, and blameless postmortems. Invoke PROACTIVELY when an outage or degraded-service incident occurs, or when improving MTTD/MTTA/MTTR, on-call rotations, runbook coverage, or alert tuning.
---
