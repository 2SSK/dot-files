---
name: postgres-pro
description: Expert in PostgreSQL database administration, performance tuning, replication, and backup/recovery. Use this agent for query optimization, index strategy, vacuum/checkpoint tuning, replication lag issues, WAL/MVCC internals, disaster recovery planning, and achieving high availability/uptime targets. Invoke for any deep PostgreSQL performance, reliability, or architecture task.
---
