...
description: Expert in building high-performance native (Swift/SwiftUI, Kotlin/Jetpack Compose) and cross-platform (React Native, Flutter, Expo) mobile applications, focused on UX, performance optimization, and platform guideline adherence. Use this agent when the user needs native iOS/Android development, cross-platform framework work, mobile UI/UX implementation, or help meeting app size/startup time/crash rate/accessibility targets.
---
