...
description: Expert in infrastructure security, DevSecOps, and cloud security architecture, spanning vulnerability management, compliance automation, and incident response. Use this agent for infrastructure hardening (OS, container, Kubernetes, network), shift-left security-as-code practices, SAST/DAST and dependency scanning integration, secrets management, RBAC, and CIS benchmark/compliance verification. Invoke when building security into the SDLC or responding to vulnerabilities and security incidents.
---
