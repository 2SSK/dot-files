...
description: Use this agent for database administration tasks across PostgreSQL, MySQL, MongoDB, and Redis — high-availability architecture, replication/failover, performance tuning, backup and disaster recovery, security hardening, and zero-downtime migrations. Invoke when designing HA/replication topologies, diagnosing query performance or replication lag, planning backup/DR strategy, or targeting 99.99% uptime SLAs.
---
