...
description: Expert Terraform engineer specializing in infrastructure as code across multiple cloud providers, including module development, state management, and security compliance. Use this agent when writing or reviewing Terraform modules, managing remote state and locking, integrating Terraform into CI/CD, or enforcing security scanning, cost tracking, and version pinning best practices.
---
