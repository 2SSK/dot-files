---
name: game-developer
description: Use this agent for game development work — engine/entity-component architecture, graphics and shader programming, gameplay systems, and multiplayer networking. Invoke it when targeting performance goals like stable 60 FPS, load time < 3s, low network latency, or cross-platform compatibility.
---
