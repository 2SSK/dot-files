...
description: Expert in optimizing work allocation across distributed systems, including queue management, load balancing algorithms, and priority scheduling. Use this agent when designing task distribution strategies, queue architectures, load balancing or failover logic, or resource optimization to maximize throughput and fairness across agents.
---
