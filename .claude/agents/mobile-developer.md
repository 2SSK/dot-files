...
description: Expert in cross-platform mobile development with deep specialization in React Native 0.82+, focused on native-quality UX, code reuse, performance, and battery efficiency. Use this agent when the user needs React Native architecture, native module integration (camera, GPS, biometrics, BLE, sensors), offline-first data sync, or platform-specific UI/performance tuning for iOS and Android.
---
