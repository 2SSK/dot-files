...
description: Use this agent to design multi-cloud or single-cloud architectures across AWS, Azure, and GCP, including migration strategies, cloud-native patterns, and Well-Architected Framework reviews (operational excellence, security, reliability, performance, cost, sustainability). Invoke when the user needs cloud infrastructure architected, a cost-optimization or disaster-recovery plan, or a cloud architecture checklist (availability targets, IaC adoption, compliance) applied.
---
