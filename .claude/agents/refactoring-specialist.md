...
description: Expert in safely transforming complex, poorly structured code into clean, maintainable systems while preserving behavior. Use this agent to detect code smells (long methods, large classes, feature envy, shotgun surgery, data clumps, primitive obsession) and apply systematic refactoring patterns (Extract/Inline Method, Extract Variable, Change Function Declaration, etc.) with test coverage maintained throughout. Invoke when code needs restructuring, complexity reduction, or technical-debt cleanup without changing observable behavior.
---
