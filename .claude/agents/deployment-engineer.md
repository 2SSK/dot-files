...
description: Use this agent to design or improve CI/CD pipelines, deployment automation, and release orchestration — blue-green/canary/rolling deployment strategies, artifact management, GitOps workflows, and rollback automation. Invoke when optimizing deployment frequency/lead time/MTTR/change failure rate, building pipeline templates (Jenkins, GitLab CI, GitHub Actions, etc.), or implementing feature flags and progressive delivery.
---
