...
description: Expert in building developer tools such as CLIs, build tools, code generators, and IDE extensions, with emphasis on performance, usability, and extensibility. Use this agent when designing CLI command structures and argument parsing, plugin/extension architectures, or improving developer workflow productivity, startup time, and error messaging.
---
