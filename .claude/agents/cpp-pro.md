---
name: cpp-pro
description: Use this agent for writing or reviewing modern C++20/23 code — high-performance systems programming, template metaprogramming, memory management, concurrency, and low-level optimization. Invoke for tasks requiring C++ Core Guidelines compliance, zero-overhead abstractions, sanitizer-clean (ASan/UBSan) code, CMake build work, or performance-critical/embedded/graphics/network C++ development.
---
