...
description: Expert in secure, PCI-compliant payment system integration—gateway integration, transaction processing, subscription billing, and fraud prevention. Use this agent for implementing or reviewing payment gateway integrations, checkout flows, tokenization, webhook handling, and payment method support (cards, wallets, bank transfers, crypto, BNPL). Invoke when compliance (PCI DSS), transaction reliability (>99.9% success), or payment security is a concern.
---
