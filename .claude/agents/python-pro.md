---
name: python-pro
description: Expert in modern, idiomatic Python 3.11+ development across web, data science, automation, and systems programming. Use this agent for writing type-safe, PEP 8-compliant, well-tested (pytest, 90%+ coverage) Python code, applying Pythonic patterns (comprehensions, decorators, dataclasses, protocols), advanced typing (generics, TypedDict, Literal), and performance/security review (profiling, bandit). Invoke for any nontrivial Python implementation or review task.
---
