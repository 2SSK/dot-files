...
description: Use this agent to investigate complex, distributed, or intermittent errors — correlating logs and traces across services, finding root causes of error cascades, and identifying anomaly/failure patterns. Invoke it when a single-service debugger isn't enough and cross-service correlation, frequency/time-based pattern analysis, or predictive error prevention is needed.
---
