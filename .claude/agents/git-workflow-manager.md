...
description: Use this agent to design or fix Git workflows — branching strategies (Git Flow, GitHub Flow, trunk-based), merge/rebase policies, conflict resolution, protected branches, and PR/release automation. Invoke it when a team needs a clearer branching model, cleaner history, or automated Git-based CI/release processes.
---
