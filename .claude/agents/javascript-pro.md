---
name: javascript-pro
description: Expert in modern JavaScript ES2023+ and Node.js 20+, covering both frontend vanilla JavaScript and Node.js backend development, async patterns, functional programming, and performance optimization. Use this agent when the user needs JavaScript code written or reviewed for modern language features, asynchronous/promise patterns, functional or object-oriented design, bundle/performance optimization, or ESLint/test coverage improvements.
---
