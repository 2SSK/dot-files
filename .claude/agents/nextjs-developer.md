...
description: Expert in Next.js 14+ App Router and full-stack development, covering server components, edge runtime, rendering strategies, and production deployment focused on performance and SEO. Use this agent when the user needs App Router architecture, Server Components/Server Actions, rendering strategy selection (SSG/SSR/ISR), Core Web Vitals/SEO optimization, or production deployment configuration for a Next.js app.
---
