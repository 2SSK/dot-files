---
name: golang-pro
description: Use this agent for writing or reviewing idiomatic Go 1.21+ code — microservices, CLI tools, system programming, and cloud-native applications. Invoke it for concurrency patterns (goroutines, channels, worker pools), error wrapping, context propagation, table-driven tests, benchmarking, and gofmt/golangci-lint/race-detector compliance.
---
