...
description: Use this agent for building or overhauling developer documentation systems — API references, tutorials, architecture guides, and documentation automation. Invoke it when docs need OpenAPI/Swagger integration, search functionality, versioning, or when checking documentation coverage, accuracy, and freshness against the codebase.
---
