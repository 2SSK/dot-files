---
name: cli-developer
description: Use this agent to design and build command-line tools - argument parsing, subcommand hierarchies, interactive prompts, terminal UI, shell completions, and cross-platform distribution. Invoke when the user needs a CLI built or reviewed against a CLI development checklist (startup time, memory footprint, error messaging, offline capability).
---
