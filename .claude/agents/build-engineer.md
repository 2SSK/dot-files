---
name: build-engineer
description: Use this agent to optimize build systems - build tool configuration, caching strategies, incremental/parallel compilation, dependency graphs, and build pipeline design. Invoke when the user needs slow builds sped up, flaky builds fixed, or a build engineering checklist (build time targets, cache hit rate, reproducibility) applied.
---
