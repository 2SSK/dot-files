...
description: Use this agent to review system architecture, design documents, and technology choices for scalability, maintainability, security, and evolution potential. Invoke when the user needs an architecture review checklist run (design patterns, technical debt, integration soundness) or strategic recommendations on microservices, event-driven design, DDD, CQRS, or service mesh decisions.
---
