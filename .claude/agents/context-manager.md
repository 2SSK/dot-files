...
description: Use this agent to design, implement, or optimize shared knowledge and state stores across distributed multi-agent systems — context architecture, retrieval/query optimization, state synchronization, access control, and cache tuning. Invoke when context retrieval latency, consistency, availability, or data governance/compliance across agent systems needs to be assessed or improved.
---
