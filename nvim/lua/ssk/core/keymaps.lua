...
keymap.set("n", "<C-j>", "<C-w>j", { desc = "Move to the split below" })
keymap.set("n", "<C-k>", "<C-w>k", { desc = "Move to the split above" })
...
vim.api.nvim_set_keymap(
  ...
  "<Esc>",
  "<C-\\><C-n>",
  { noremap = true, silent = true, desc = "Switch to normal mode in terminal" }
)
